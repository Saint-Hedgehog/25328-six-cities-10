...
import { getErrorMessage, getReviewSendStatus, getReviewSendSuccessStatus } from '../../../../store/review-data/selectors';
...
const FormReview: React.FC<FormReviewProps> = ({ offerId }) => {
  ...
  const textareaClass = classNames('reviews__textarea form__textarea', {'error__reviews__textarea horizontal-shake': isErrorMessage});
  ...
  return (
    <form className="reviews__form form" action="#" method="post">
      ...
      {isErrorMessage ? <ErrorMessage errorMessage={errorMessage} /> : null}
